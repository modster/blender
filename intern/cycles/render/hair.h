...
class Hair : public Geometry {
 public:
  ...
  NODE_PUBLIC_API(array<float3>, curve_keys)
  NODE_PUBLIC_API(array<float>, curve_radius)
  NODE_PUBLIC_API(array<int>, curve_first_key)
  NODE_PUBLIC_API(array<int>, curve_shader)
