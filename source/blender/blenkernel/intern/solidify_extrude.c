...
//    float nor[3];
//#endif
//    const uchar crease_rim = 255.0f;//smd->crease_rim * 255.0f;
//    const uchar crease_outer = 255.0f;//smd->crease_outer * 255.0f;
//    const uchar crease_inner = 255.0f;//smd->crease_inner * 255.0f;
//
//    int *origindex_edge;
//    int *orig_ed;
//    uint j;
