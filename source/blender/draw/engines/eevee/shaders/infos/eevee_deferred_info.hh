...
GPU_SHADER_CREATE_INFO(eevee_deferred_eval)
    ...
    .sampler(7, ImageType::FLOAT_2D, "ray_radiance_diffuse_tx")
    .sampler(8, ImageType::FLOAT_2D, "ray_radiance_refract_tx")
    .sampler(9, ImageType::FLOAT_2D, "ray_radiance_reflect_tx")
