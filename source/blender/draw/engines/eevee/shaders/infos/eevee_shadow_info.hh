...
GPU_SHADER_CREATE_INFO(eevee_shadow_page_alloc)
    ...
    .storage_buf(1, Qualifier::READ, "ShadowTileMapData", "tilemaps[]")
    .storage_buf(2, Qualifier::READ_WRITE, "uint", "free_page_owners[]")
    .storage_buf(3, Qualifier::READ_WRITE, "ShadowPagesInfoData", "infos")
...
GPU_SHADER_CREATE_INFO(eevee_shadow_page_defrag)
    ...
    .additional_info("eevee_shared")
    .local_group_size(1)
    .storage_buf(0, Qualifier::READ_WRITE, "uint", "free_page_owners[]")
    .storage_buf(1, Qualifier::READ_WRITE, "ShadowPagesInfoData", "infos")
    .image(0, GPU_R32UI, Qualifier::READ_WRITE, ImageType::UINT_2D, "tilemaps_img")
...
GPU_SHADER_CREATE_INFO(eevee_shadow_page_free)
    ...
    .storage_buf(0, Qualifier::READ_WRITE, "uint", "free_page_owners[]")
    .storage_buf(1, Qualifier::READ_WRITE, "ShadowPagesInfoData", "infos")
    .storage_buf(2, Qualifier::READ, "ShadowTileMapData", "tilemaps[]")
    .image(0, GPU_R32UI, Qualifier::READ_WRITE, ImageType::UINT_2D, "tilemaps_img")
...
GPU_SHADER_CREATE_INFO(eevee_shadow_page_init)
    ...
    .storage_buf(0, Qualifier::WRITE, "uint", "free_page_owners[]")
    .storage_buf(1, Qualifier::WRITE, "ShadowPagesInfoData", "infos")
    .image(0, GPU_R32UI, Qualifier::READ_WRITE, ImageType::UINT_2D, "tilemaps_img")
...
GPU_SHADER_CREATE_INFO(eevee_shadow_tilemap_lod_mask)
    ...
    .additional_info("eevee_shared")
    .local_group_size(SHADOW_TILEMAP_RES, SHADOW_TILEMAP_RES)
    .storage_buf(0, Qualifier::READ, "ShadowTileMapData", "tilemaps[]")
    .image(0, GPU_R32UI, Qualifier::READ_WRITE, ImageType::UINT_2D, "tilemaps_img")
...
GPU_SHADER_CREATE_INFO(eevee_shadow_page_debug)
    ...
    .additional_info("eevee_shared")
    .storage_buf(1, Qualifier::READ, "uint", "free_page_owners[]")
    .image(0, GPU_R32UI, Qualifier::READ_WRITE, ImageType::UINT_2D, "tilemaps_img")
