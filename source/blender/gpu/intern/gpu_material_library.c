...
static GPUMaterialLibrary gpu_shader_composite_color_spill_library = {
    .code = datatoc_gpu_shader_composite_color_spill_glsl,
    .dependencies = {NULL},
};
...
static GPUMaterialLibrary gpu_shader_composite_gamma_library = {
    .code = datatoc_gpu_shader_composite_gamma_glsl,
    .dependencies = {&gpu_shader_common_math_util_library, NULL},
};
...
static GPUMaterialLibrary gpu_shader_material_tex_brick_library = {
    ...
    .dependencies = {&gpu_shader_common_math_util_library, &gpu_shader_common_hash_library, NULL},
};
