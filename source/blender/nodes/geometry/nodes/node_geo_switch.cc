...
static bNodeSocketTemplate geo_node_switch_in[] = {
    ...
    {SOCK_FLOAT, N_("False"), 0.0, 0.0, 0.0, 0.0, -FLT_MAX, FLT_MAX, PROP_NONE, SOCK_IS_FIELD},
    {SOCK_FLOAT, N_("True"), 0.0, 0.0, 0.0, 0.0, -FLT_MAX, FLT_MAX, PROP_NONE, SOCK_IS_FIELD},
    {SOCK_INT, N_("False"), 0, 0, 0, 0, -100000, 100000, PROP_NONE, SOCK_IS_FIELD},
    {SOCK_INT, N_("True"), 0, 0, 0, 0, -100000, 100000, PROP_NONE, SOCK_IS_FIELD},
    {SOCK_BOOLEAN, N_("False"), 0.0, 0.0, 0.0, 0.0, -FLT_MAX, FLT_MAX, PROP_NONE, SOCK_IS_FIELD},
    {SOCK_BOOLEAN, N_("True"), 0.0, 0.0, 0.0, 0.0, -FLT_MAX, FLT_MAX, PROP_NONE, SOCK_IS_FIELD},
    {SOCK_VECTOR, N_("False"), 0.0, 0.0, 0.0, 0.0, -FLT_MAX, FLT_MAX, PROP_NONE, SOCK_IS_FIELD},
    {SOCK_VECTOR, N_("True"), 0.0, 0.0, 0.0, 0.0, -FLT_MAX, FLT_MAX, PROP_NONE, SOCK_IS_FIELD},
    {SOCK_RGBA, N_("False"), 0.8, 0.8, 0.8, 1.0, -FLT_MAX, FLT_MAX, PROP_NONE, SOCK_IS_FIELD},
    {SOCK_RGBA, N_("True"), 0.8, 0.8, 0.8, 1.0, -FLT_MAX, FLT_MAX, PROP_NONE, SOCK_IS_FIELD},
