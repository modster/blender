 ...
 * something that can be known at scheduling-time. See the discussion in VPC_compile_state.hh,
 * VPC_evaluator.hh, and VPC_gpu_material_operation.hh for more information. In the node tree shown
